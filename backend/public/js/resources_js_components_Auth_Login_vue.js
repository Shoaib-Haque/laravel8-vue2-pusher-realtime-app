        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 1;
              _context.next = 4;
              return axios.post('/api/auth/admin/login', form);
            case 4:
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_vm._v(" Login ")]), _vm._v(" "), typeof _vm.errors === "string" ? _c("p", {
    staticClass: "list-disc text-red-400"
  }, [_vm._v(_vm._s(_vm.errors))]) : _vm._e(), _vm._v(" "), _c("form", {
    attrs: {
      method: "post"
    },
    on: {
    ...
    staticClass: "shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker",
    attrs: {
      id: "username",
      type: "text",
      required: ""
    ...
    staticClass: "shadow appearance-none border border-red rounded w-full py-2 px-3 text-grey-darker mb-3",
    attrs: {
      id: "password",
      type: "password",
      required: ""
    ...
    staticClass: "bg-blue-500 hover:bg-blue-900 text-white font-bold py-2 px-4 rounded",
    attrs: {
      type: "submit"
    }
  }, [_vm._v("\n                    Sign In\n                ")]), _vm._v(" "), _c("router-link", {
    staticClass: "inline-block align-baseline font-bold text-sm text-blue hover:text-blue-darker",
    attrs: {
      to: "register"
    }
  }, [_vm._v("\n                    Sign Up\n                ")])], 1)])])]);
